...
public sealed class LearnDialogViewModel : ILearnDialogViewModel
{
    ...
    {
        Word = "Word",
        Translation = "A very long translation text, so long that you need to wrap it",
    ...
    public ReactiveCommand<Unit, Unit> ExitCommand { get; } = ReactiveCommand.CreateFromTask(_ => Task.FromResult(Unit.Default));
}
